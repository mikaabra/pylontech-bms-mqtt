...
### Commit Pending:
"Optimize logging to prevent ESP32 reboots, add diagnostic counters"

**Changes:**
- Reduce default logger level to WARN
- Add conditional DEBUG-only verbose logging
- Add RS485 error logging with hex dumps
- Add diagnostic counters: RS485/CAN frames and errors
- Add periodic CAN health summary
- Remove excessive per-frame/per-request logging

**Result:** Stable operation with maintained diagnostics, 6KB firmware reduction
