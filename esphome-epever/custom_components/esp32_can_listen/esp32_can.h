...
class ESP32CanListen : public canbus::Canbus {
 public:
  ...
  // Runtime mode switching - stops and restarts the driver with new mode
  bool switch_to_normal_mode();
  CanMode get_mode() { return mode_; }
  ESP32CanListen(){};
